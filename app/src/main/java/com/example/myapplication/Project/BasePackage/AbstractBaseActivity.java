...
public  abstract class AbstractBaseActivity  <V extends InterfaceBaseView, P extends AbstractBasePersent<V>> extends AppCompatActivity implements InterfaceBaseView {
    private P presenter;
